...
export const apiService = {
  ...
  timeoutMember: (serverId, memberId, duration, reason) => api.post(`/servers/${serverId}/members/${memberId}/timeout`, { duration, reason }),
  voiceDisconnectMember: (serverId, memberId) => api.post(`/servers/${serverId}/members/${memberId}/voice-disconnect`),
  ...
  markChannelRead: (channelId) => api.post('/user/mark-read', { channelId }),
